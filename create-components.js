// Script pour créer tous les composants React
const fs = require('fs');
    ...
    <header className="fixed w-full z-50 bg-dark/80 backdrop-blur-lg border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          >
            <img src="/assets/logo.png" alt="Eterna Tech" className="h-10" />
      ...
      <div
        className={\`md:hidden fixed inset-0 top-[73px] bg-dark/95 backdrop-blur-lg transition-all duration-300 \${
